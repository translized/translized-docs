...
Translized has multiple user roles within projects, so you can easily collaborate and successfully translate your terms.

:::tip
Learn more about [managing users within Translized.](/docs/guides/user-management)
:::
...
| Edit Terms                  | <Chip color="blue" title="Yes" /> | <Chip color="blue" title="Yes" /> |       <Chip color="red" title="No" />        |
...
| Add Term Tags               | <Chip color="blue" title="Yes" /> | <Chip color="blue" title="Yes" /> |       <Chip color="red" title="No" />        |
