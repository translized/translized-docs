...
You can also see instructions on our [GitHub](https://github.com/translized/android-SDK)
...
**Note!** If you don’t have _BaseActivity_ class add this code to all of your activities.
