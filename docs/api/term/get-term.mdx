...
| termKey   | String | True     | Key of term to add |
| languageCode | String | False    | Language code. If defined translation will be returned only for that language. If not defined all term translations are returned. |
