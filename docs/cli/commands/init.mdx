...
### 5. (Optionaly) Upload file language code

If you used `<locale_code>` this will be automatically extracted.

Only if you specify exact filepath (without `<locale_code>`) you will be asked for a language code for upload file. By default it is **English** (en).
