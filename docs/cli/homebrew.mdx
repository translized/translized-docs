...
Follow the next steps to download and import localization files to your project.
Before starting make sure you have **projectId** and **api-token**, which you can find in Project Statistics and Account/API Access.

To install translized-cli via [Brew](https://brew.sh/), simply use:
