...
Send project events notifications to a chosen [Slack](https://www.slack.com) channel.
...
- Go to `Integrations -> Slack`, once there for the first time you should see **Install** button, click on it.
...
![/docs/integrations/slack/translized-slack-1.png](/docs/integrations/slack/slack_2.png)
...
| Modified                    |                    When key is edited                     |
| Deleted                     |                    When key is deleted                    |
| Comment added               |             When comment is added to the key              |
| <b>Translation</b>          |
