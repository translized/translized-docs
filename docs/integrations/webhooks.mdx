...
**2. All translation translated** - _Trigger when when all keys are translated to every language_
...
**3. All translations verified** - _Trigger when when all keys translations are verified_
...
**1. Added** - _Trigger when new key is added from Translized app_
...
**2. Modified** - _Trigger when key is modified (edited)_
...
**3. Deleted** - _Trigger when key is deleted_
